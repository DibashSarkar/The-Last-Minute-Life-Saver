    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-6 font-sans">
      <div className="max-w-sm w-full bg-slate-900/40 border border-slate-900 rounded-2xl p-6 backdrop-blur-sm shadow-xl space-y-6">
        ...
        <div className="space-y-1 text-center">
          ...
          <p className="text-[10px] text-slate-500">We'll dispatch a secure recovery links passkey</p>
        </div>

        {isSent ? (
          <div className="bg-emerald-950 border border-emerald-500/40 text-emerald-300 text-[10px] p-3 rounded-lg text-center font-semibold animate-pulse">
            ✓ Recovery link dispatched! Please verify your inbox.
          </div>
        ) : (
